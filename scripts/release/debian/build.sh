...
find ${WORKDIR}/src/ -name setup.py -type f | xargs -I {} dirname {} | grep -v azure-cli-testsdk | xargs pip3 install --no-deps --compile
pip3 install -r ${WORKDIR}/src/azure-cli/requirements.py3.$(uname).txt --compile
